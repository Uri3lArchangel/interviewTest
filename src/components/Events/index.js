...
import { container, rows, heading, ptag, button } from "./events";
...
export default function Events() {
  ...
  //   let contract = new ethers.Contract(mintEventAddress, MintEvent.abi, signer);
  ...
  //   contract = new ethers.Contract(ethrtainAddress, Ethrtainment.abi, signer);
          ...
          <CardGroup>
            <Card>
              ...
              <Card.Footer>
                ...
                <div>
            {/*onClick={buyTicket}*/ }      <Button  style={button} href="#">
                    Buy NFT
                  </Button>
                  {/* onClick={checkTicket} */}
                  <Button  style={button}>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>Outdoor events ready for viewing.</Card.Text>
              </Card.Body>
              <Card.Footer>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Watch ZED RUN digital horse racing or the Kentucky Derby. BET
                  BIG or GO HOME
                </Card.Text>
              </Card.Body>
              <Card.Footer>
